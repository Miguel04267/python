...
class Sessao(ModeloBase):
    ...
    sala_id = db.Column(db.Integer, db.ForeignKey(salas_id), nullable=False)
    data_hora = db.Column(db.DateTime, nullable=False)
    preco = db.Column(db.Float, nullable=False)

    filme_id = db.relationship("Filme", back_populates="sessoes")
    sala_id = db.relationship("Sala", back_populates="sessoes")
